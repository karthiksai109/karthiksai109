...
Recently won the Akash Open Agents Hackathon 2026 with HealthGuard, a decentralized private AI health agent. Currently focused on building AI agents, RAG systems, and shipping real products.

US work authorized (OPT). Open to full-time Software Engineer, Full Stack, and AI/ML Engineering roles.

## What I'm working on

- AI agents powered by AWS Bedrock, OpenAI, and Venice AI
- RAG pipelines with FAISS and vector search (no LangChain, built from scratch)
- Full-stack apps with Next.js, TypeScript, and Firebase
...
**Frontend:** React, Next.js 14, React Native, TailwindCSS, Framer Motion

**Backend:** Node.js, Express.js, REST APIs, Serverless Functions
...
**Cloud & DevOps:** AWS (S3, EC2, Bedrock), Netlify, Vercel, Docker, Datadog, Git
...
- [Portfolio](https://karthikramadugu.vercel.app)
- [LinkedIn](https://www.linkedin.com/in/ramadugukarthik)
- [Email](mailto:karthiksaidham2001@gmail.com)
